...
export const sections: Section[] = [
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: "KF1-DI-04", title: "List races with missing pole times",                        complexity: "S", status: "pending", description: "Query races with no entry in the poletimes table, grouped by year, to identify where qualifying time data needs to be added. CHECKED 1 Jul 2026 — 119 races missing, all from 2021 onwards (2021: 19, 2022: 22, 2023: 22, 2024: 24, 2025: 24, 2026 R1–R8: 8). Zero gaps in 1950–2020 data. The poletimes table was simply never populated for recent seasons. Data entry backlog — see also KF1-X-04." },
